---
name: instagram-pink-baller-carousel
description: >
  Erstellt 10-Slide-Instagram-Carousel-Posts im hellrosa/weissen fragRoger Pink-Baller-Stil aus PDFs,
  Blog-Artikeln, Texten, URLs oder Notizen. Verwenden bei: Instagram Pink Carousel, hellrosa Carousel,
  pinke Baller-Slides, Content zu Instagram in Pink, PDF zu Instagram Carousel, Blog zu Pink Carousel,
  Roger Pink Stil, helle Instagram Slides mit starken Bildmotiven. Output: 10 Slide-Bilder im 4:5-Format
  mit bildstarken Baller-Motiven auf Slide 1-3 und Slide 9, bold-cinematischem Pink-Poster-Design,
  Caption, Review-Paket und optionales Posting nach expliziter Freigabe.
---

# Instagram Pink Baller Carousel - fragRoger Light Cinematic

## Workflow-Übersicht

1. **Inhalt aufnehmen** - Text, URL, PDF, Datei oder Notizen akzeptieren. Extrahiere These, Konflikt, Pointe und konkreten Nutzen für Entscheider:innen.
...
3. **Carousel-Struktur extrahieren** - mit `scripts/extract_pink_content.py` oder manuell eine 10-Slide-Struktur erzeugen.
4. **10 Slide-Bilder generieren** - im 4:5-Format, hellrosa/weiss, bold, cinematic, TED-Talk-/Kinoposter-artig und konsequent im **Pink-Baller-Plakat-Modus**: echte visuelle Hook-Motive, grosse Headline-Flächen, klare Safe-Zones, starke Typografie, keine kleinteilige Textplatzierung.
5. **Caption verfassen** - Hook, Kontext, Implikation, CTA, `#fragRoger`.
6. **Review vor Posting einholen** - finale Slides, Kontaktübersicht und Caption zeigen. Erst nach expliziter Freigabe posten.
...
Akzeptiere Inhalte als Text, URL, PDF, Markdown, HTML oder Notizen. Ziel ist nicht Zusammenfassung, sondern Social-Media-Übersetzung: Was ist die entscheidende These, welches Missverständnis wird gebrochen, welche Konsequenz entsteht und welche Handlungsperspektive folgt daraus?
...
2. Wenn kein Bildmaterial geliefert wird, erstelle KI-generierte Pink-Baller-Motive für Slide 1, Slide 2, Slide 3 und Slide 9.
...
7. Die Bildmotive sind hell, editorial und pink-cinematic, müssen aber trotzdem Tiefe, Schatten, Kontrast und Dramatik haben. Hell darf nicht flach werden.

**Merksatz:** Keine ersten drei Slides ohne echtes Bildmotiv. Wenn Slide 1-3 aussehen wie Text auf rosa Verlauf, ist der Carousel noch nicht fertig. Das ist dann nett. Nett scrollt weg.

## Schritt 3: Carousel-Struktur extrahieren

```bash
python /home/ubuntu/skills/instagram-pink-baller-carousel/scripts/extract_pink_content.py \
...
- Textblöcke nicht schüchtern in die Ecke setzen. Verwende klare Zonen: **oben dominant**, **zentriert dominant** oder **unten dominant**.
- Maximal **1 bis 4 Wörter pro Zeile**, harte Umbrüche bewusst setzen. Lieber fünf starke Kurzzeilen als eine lange Satzwurst, die aussieht wie ein Amtsformular mit Erdbeermilch.
...
- Ein Schlüsselwort pro Slide darf in Hot Pink stehen. Der Rest bleibt Anthrazit, dunkles Navy oder Schwarz.
- Helle Hintergründe brauchen trotzdem Kontrast: Schatten, cremefarbene Flächen, Vignette, Cutouts oder grosse dunkle Typo-Zonen einsetzen.
...
- **Keine generischen Tech-Hintergründe** auf Key-Slides. Abstrakte Neonlinien, zufällige Partikel oder leere Pink-Gradient-Flächen zählen nicht als Bildmotiv.

**Merksatz:** Erst Bildidee, dann Typografie, dann Dekoration. Der Algorithmus scrollt schnell. Kleine Schrift ist höflich, aber leider unsichtbar. Rosa ohne Konflikt ist Deko. Deko konvertiert selten.

## Pink-Baller-Designsystem

| Element | Vorgabe |
|---|---|
| Hintergrund | Light Pastel Pink `#FFD6E7`, Creme `#FFF3F7`, White `#FFFFFF`, helle Papierflächen |
| Primärtext | Anthrazit/Schwarz `#1F2430` oder sehr dunkles Navy |
| Akzent | Hot Pink `#FF1490` für 1 Schlüsselwort pro Slide |
| Sekundärakzent | Electric Blue `#4A7FA1` für kleine Marker, Circuit-Details, Slide-Counter |
| Typografie | Avenir Next / Barlow Condensed 900, uppercase, riesig, posterartig |
| Bildsprache | Editorial, cinematic, KI-Magazincover, helle Kinoposter-Ästhetik |
| Texturen | Subtile Graffiti-Textur, Papierkorn, Filmgrain, Cutout, sanfte Schatten, Interface-Details |

## Prompt-Vorlage pro Slide

Generative Bild-Prompts immer auf Englisch schreiben, weil Bildmodelle damit stabiler arbeiten. Exakten Slide-Text auf Deutsch mit Schweizer Rechtschreibung angeben.

```text
Generate a single Instagram carousel slide image (4:5 ratio, minimum 1080x1350 feel) in the fragRoger Pink Baller light cinematic TED Talk style.

DESIGN SYSTEM:
- Style: bold bright cinematic TED Talk poster meets editorial magazine cover with subtle urban graffiti texture.
- Background: light pastel pink #FFD6E7, cream #FFF3F7 and clean white #FFFFFF, with cinematic depth, soft shadows, paper grain and strong contrast. Bright does not mean flat.
- Typography: Avenir Next / Barlow Condensed 900, ultra-large uppercase headlines, very few words, bold keynote poster composition. The headline must dominate the slide and occupy roughly 45-70% of the visible canvas; on hero slides it may occupy up to 85% of the width if still fully readable. Use clean positive line spacing, never overlapping text.
- Brand colors: Anthracite #1F2430, Hot Pink #FF1490, Electric Blue #4A7FA1, White #FFFFFF.
- Slide 1, Slide 2, Slide 3 and Slide 9 MUST include strong cinematic image motifs, not just text on a pink abstract background. Use user-provided images if available; otherwise generate suitable AI image motifs.
- NO underline dividers, NO thin separator lines, NO decorative horizontal rules.
- Do NOT use spray-paint divider lines. Use scale, contrast, image depth, shadows, light, framing and composition instead.
...
OUTPUT: Generate exactly one premium Instagram carousel slide. It should feel like a bright cinematic keynote poster, not a worksheet. The typography must be oversized, bold, dramatic, and intentionally placed.
```
...
Must include the strongest image motif of the carousel. Use the provided image if available; otherwise generate a cinematic hero image with a concrete subject, strong scene and visual conflict.
The image should feel like a feed-stopping bright movie poster: a person, bot, object, crisis, absurd metaphor or dramatic situation that visualises the core hook. Avoid generic pastel or tech backgrounds.
Light pink/white poster world, cinematic shadows, dramatic crop, high contrast. Massive uppercase headline with 5-10 words. The headline must be huge, poster-like, and dominate the image without hiding the subject.
...
Use oversized bold typography, bright cinematic pink/white depth, one strong visual metaphor. The text block should feel like a stage headline: large, assertive, and deliberately placed.
...
Make it feel personal, direct and slightly uncomfortable, but in the bright Pink-Baller visual world.
No underline. No divider. Max 1-2 lines.
```
...
Use bold bright cinematic composition, very large type, subtle texture, strong contrast. The type must carry the slide even without the background image.
No underline. No divider. Max 1-2 lines.
```
...
Use the most dramatic typographic composition after Slide 1. Bright background, dark headline, one hot-pink emphasis.
No underline. No divider. Max 1-2 lines.
```
...
Use a comment CTA only when the user explicitly asks for it or when the comment keyword directly supports a clear lead magnet. Do not invent generic keywords without strategic reason.
...
[2-3 Sätze Kontext aus dem Inhalt - präzise, keine Buzzwords]
...
Vor dem Posting immer die finalen Slides und die Caption zur Review zeigen. Erst nach expliziter Freigabe posten. Wenn der Nutzer nach Review «posten» schreibt, gilt das als Freigabe für die zuletzt gelieferte Review-Version.
...
- Bold cinematic TED-Talk-Design, keine Worksheet-Optik.
...
- Typografie muss **bold cinematic, TEDx-artig und kinoplakatfähig** sein: grossflächig, kontrastreich, sauber gesetzt, nicht gedrängt. Keine negativen Zeilenabstände, keine überlappenden Zeilen.
- Light first: Pastell-Rosa, Creme und Weiss, aber mit starken Schatten, Kontrastflächen, Tiefe und klarer Hierarchie.
- Hot Pink `#FF1490` sparsam als Einzelakzent einsetzen.
- Electric Blue `#4A7FA1` als sekundären Akzent einsetzen.
- Maximal 1-2 Textblöcke pro Slide, ausser Slide 9. Pro Zeile möglichst 1-4 Wörter. Keine langen Satzwürste, die aussehen wie ein Amtsformular im Barbie-Kostüm.
...
- Slide 10 muss als starker Engagement Trigger funktionieren: heller Abschluss, klare Handlung, speichern, teilen, folgen oder themenspezifischer Kontakt-CTA.
...
- [ ] Keine Key-Slide 1-3 oder 9 ist nur Text auf abstraktem rosa Hintergrund.
- [ ] Keine Unterstriche, keine Trennlinien, keine horizontalen Divider.
...
- `scripts/extract_pink_content.py` - KI-gestützte Extraktion der 10-Slide-Struktur für Pink-Baller-Carousels.
